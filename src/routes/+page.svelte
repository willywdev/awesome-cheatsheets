...
<section class="flex flex-col items-center ">
    ...
    <h2 class="mt-3 text-xl">Welcome to Awesome Cheatsheets!</h2>
    ...
    <p class="mt-2 mb-2 text-lg text-center text-primary-400">Level up your skills, one cheat sheet at a time. Let's get started!</p>
</section>
